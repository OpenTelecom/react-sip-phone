    ...
    <React.Fragment>
      ...
      <ReactSipPhone
        ...
        phoneConfig={{
          ...
          appSize: 'large' // assign 'large' for larger font in status-name and session-status. Dialpad and dialbuttons will be larger (not session remote-id/display name)
        }}
        width={0}
      />
    </React.Fragment>
