...
export const AUDIO_NEW_INPUT_DEVICES_DETECTED = 'AUDIO__NEW_INPUT_DEVICES_DETECTED'
export const AUDIO_NEW_OUTPUT_DEVICES_DETECTED = 'AUDIO__NEW_OUTPUT_DEVICES_DETECTED'

export const AUDIO_DEVICES_SWAP = 'AUDIO_DEVICES_SWAP'
...
export const getNewInputAudioDevices = () => {
  let inputArray: Array<Object> = []
  navigator.mediaDevices
    .enumerateDevices()
    .then(function (devices: Array<Object>) {
...
export const getNewOutputAudioDevices = () => {
  let outputArray: Array<Object> = []
  navigator.mediaDevices
    .enumerateDevices()
    .then(function (devices: Array<Object>) {
